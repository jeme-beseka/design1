...
const TopShopCarousel = () => {
  ...
  const renderShop = (shop) => (
    <div className="w-64 bg-white rounded-lg shadow-sm p-4 h-50">
      <img 
        src={shop.image} 
        alt={shop.name}
  ...
  return (
    <AutoScrollCarousel
      ...
      title={
        <Link to="/shops" className="group inline-flex items-center gap-2">
          Top Rated Shops
          <span className="text-gray-400 group-hover:text-gray-600">(View All)</span>
        </Link>
      }
...
export default TopShopCarousel;